...
0. **[Reading Timer](https://elementpack.pro/demo/element/reading-timer/)** - Auto count the content reading time and display it to your readers with a very simplified Reading Timer feature. Note that the estimated time is based on the standard value.
...
0. **[Review Card Carousel](https://elementpack.pro/demo/element/review-card-carousel/)** - The review card carousel is an amazing widget, developed for showcasing customizable customer reviews with a carousel animation panel. See the demo
0. **[Simple Contact Form](https://elementpack.pro/demo/element/simple-contact-form/)** - Simple Contact Form is a custom contact form making tool that you can use as a quick tool for collecting leads.
...
0. **[Step Flow](https://elementpack.pro/demo/element/step-flow/)** - Step Flow is for designing flow charts with a new style and interface. Now, re-build your instruction manual with bright colors. 
...
0. **[Search](https://elementpack.pro/demo/element/search/)** - Search is a simple search widget that provides interactive search fields on your webpage for your users. You can get a simple search, modal options also.
...
0. **[Events Calendar Grid](https://elementpack.pro/demo/element/events-calendar-grid/)** - Consist of customizing grid, column number with the image or without images, and many other options. You must need this if you're building an event-based site.
...
0. **[Asset Manager](https://www.elementpack.pro/knowledge-base/how-to-use-asset-manager/)** - If you want to combine your JS and css and load in a single file so enable it. When you enable it all css and JS will combine in a single file.
...
0. **[Duplicator](https://www.elementpack.pro/knowledge-base/how-to-use-element-pack-duplicator/)** - Turn on this switcher to enable the Duplicator. It's available for posts, pages and templates

More features & extensions are coming soon...

== Pro Version Core Widgets 🔥 ==

0. **[Advanced Button](https://elementpack.pro/demo/element/advanced-button/)** - Element Pack Plugin provides addon for with advanced features for the button. Watch the Advanced Button Demo now.
0. **[Advanced Calculator](https://elementpack.pro/demo/element/advanced-calculator/)** - Looking for a on-site calculator feature? This is the perfect widget that allows you do place user interactive calculators easily on your website. See the demo
0. **[Advanced Counter](https://elementpack.pro/demo/element/advanced-Counter/)** - Advanced Counter  allows you to create fully customizable counters, displaying tones of stat and numbers with both static and dynamic configuration.
0. **[Advanced Divider](https://elementpack.pro/demo/element/advanced-divider/)** - Advanced Divider lets you place colorful as well as unique dividers in your webpages. 
0. **[Advanced Heading](https://elementpack.pro/demo/element/advanced-heading/)** - You can easily add the advanced feature in the heading of your content using this amazing heading designer feature. Watch the demo now.
0. **[Advanced Google Map](https://elementpack.pro/demo/element/advanced-google-map/)** - If you want to make some advanced map with a customized feature, this advanced google map addon is your solution.
0. **[Animated Heading](https://elementpack.pro/demo/element/animated-heading/)** - You can easily add animation in the heading of your content using this heading creator tool. Animated Heading is a cool feature to have.
0. **[Advanced Icon Box](https://elementpack.pro/demo/element/advanced-icon-box/)** - Make your content more organized and eye-catching with Advanced Icon Box. Great tools for your website to present your content.
0. **[Advanced Image Gallery](https://elementpack.pro/demo/element/advanced-image-gallery/)** - If you want to add some advanced feature to your element page builder based site, you can consider looking at advanced image gallery developed by us.
...
0. **[Barcode](https://elementpack.pro/demo/element/barcode/)** - Barcode is a specialty tool for generating barcodes for your products. This is an online barcode tool developed for adding digitally certified imprints over a large category of products. See the demo
0. **[Breadcrumbs](https://elementpack.pro/demo/element/breadcrumbs/)** - Get Breadcrumbs for ease of access, better navigation, and improved user experience.
...
0. **[Circle Menu](https://elementpack.pro/demo/element/circle-menu/)** - You can now add a cool circle menu with animation that creates a stunning visual effect to captivate your visitors in one shot.
...
0. **[Dynamic Carousel](https://elementpack.pro/demo/element/dynamic-carousel/)** - Dynamic Carousel is similar to the Dynamic Grid widget, a flexible grid maker tool that can load any kind of page/section template. See the demo
...
0. **[Interactive Card](https://elementpack.pro/demo/element/interactive-card/)** - The Interactive Card widget is  featuring highlights and posts with a smooth graphical flow.
...
0. **[Image Expand](https://elementpack.pro/demo/element/image-expand/)** - The Image Expand widget creates a unique image accordion where clicking on any image will expand it into a slider while popping back other pictures.
...
0. **[Iframe](https://elementpack.pro/demo/element/iframe/)** - Options with audio, video google map embedding options and lazy load scroll bars, 360-degree view, basic dashboard customization examples
...
0. **[LearnPress Grid](https://elementpack.pro/demo/element/learnpress-grid/)** - The LearnPress grid is a 3rd party integration for providing all the existing features of LearnPress with additional enhancements and customizations. With our LearnPress Grid widget, it is possible to create beautiful grid interfaces to line up your courses while displaying necessary info in an orderly manner.
0. **[LearnPress Carousel](https://elementpack.pro/demo/element/learnpress-carousel/)** - Our LearnPress Carousel is a great way to display your courses in any WordPress website and turn it into your own LMS platform. With this, you can easily create an attractive and informative line up of your courses. Additionally, our widget provides all the existing features of LearnPress with additional customizations.
...
0. **[Logo Carousel](https://elementpack.pro/demo/element/logo-carousel/)** - Moving content can attract more visitors. Logo Carousel can do that in a user-friendly way.
...
0. **[Protected Content](https://elementpack.pro/demo/element/protected-content/ )** - Password protected WordPress form and style changer from your dashboard. A fancy way to style and protect content.
...
0. **[Post Slider](https://elementpack.pro/demo/element/post-slider/)** -Post Slider allows you to display your blog posts in a very beautiful slider that will be present your content more dynamically. 
...
0. **[Post Grid](https://elementpack.pro/demo/element/post-grid/)** -Skin (Alter) Example,Skin (Paddle) Example,Skin (Trosia) Example, Skin Elanza Example,Skin Modern,Skin Carmie post grid widget.
...
0. **[Post List](https://elementpack.pro/demo/element/post-list/)** - Post List lets you create dynamic listing to onboard and display posts inside your website with fine-tuned layouts and custom designs.
...
0. **[QR Code](https://elementpack.pro/demo/element/qr-code/)** - Generate custom QR Code with the help of our plugin and create your branding QR codes with color, text, or image customizations. 
...
0. **[Remote Pagination](https://elementpack.pro/demo/element/remote-pagination/)** - The remote pagination is a remote switch that you can use to provide navigational controls for sliders and carousels with a remote operation attached. Just hook links and the pagination will work.
...
0. **[Slideshow](https://elementpack.pro/demo/element/slideshow/)** - Variations, easy positioning, customizations gives slider a ninja way to make your website classic.
0. **[Social Proof](https://elementpack.pro/demo/element/social-proof/)** - Social Proof is for displaying proofs of positive vibe using social media channels. Works great with Facebook, Google, Yelp, etc.
...
0. **[Switcher](https://elementpack.pro/demo/element/switcher/)** - Switcher to showcase your content more interactively. You can add two different content to show within the space required to show one.
...
0. **[Stacker](https://elementpack.pro/demo/element/stacker/)** - Want to Feel amazing sliding Experience?  Stacker widget can get you that. You can make your section overly and stack up with this widget simultaneously!
...
0. **[Video Gallery](https://elementpack.pro/demo/element/video-gallery/)** - Create flexible video galleries in WordPress and display everything in one place. Enjoy lots of customizations and features.
0. **[Vertical Menu](https://elementpack.pro/demo/element/vertical-menu/)** - Vertical menu widget is dedicated to our beloved eCommerce shop owners, adding a vertically aligned menu panel, boosting user experience to another level.
...
0. **[Webhook Form](https://elementpack.pro/demo/element/webhook-form/)** - Create customizable user forms and pull data directly to your desired automation website or database with the Webhook Form widget. Includes target URL field and Security Authentication check options.
...
0. **[bbPress Single Forum](https://elementpack.pro/demo/element/bbpress-single-forum/)** - 
0. **[bbPress Topic Index](https://elementpack.pro/demo/element/bbpress-topic-index/)** - Helps display available topics created within your forum in a list view to help users navigate them from one place.
0. **[bbPress Topic Form](https://elementpack.pro/demo/element/bbpress-topic-form/)** - A customizable form for your users to create topic through the help of bbPress.
0. **[bbPress Single Topic](https://elementpack.pro/demo/element/bbpress-single-topic/)** - Display reply topics from the bbPress forum system with some handy customizations from the editor.
0. **[bbPress Reply Form](https://elementpack.pro/demo/element/bbpress-reply-form/)** - Adds a customizable reply form to your forum for the users to submit their reply on any topic at anytime. (approval system may available through bbPress)
0. **[bbPress Single Reply](https://elementpack.pro/demo/element/bbpress-single-reply/)** - Lets you customize the single reply appearance on your webpage and display your branding.
0. **[bbPress Topic Tags](https://elementpack.pro/demo/element/bbpress-topic-tags/)** - 
0. **[bbPress Single Tag](https://elementpack.pro/demo/element/bbpress-single-tag/)** - 
0. **[bbPress Single View](https://elementpack.pro/demo/element/bbpress-single-view/)** - 
0. **[bbPress Stats](https://elementpack.pro/demo/element/bbpress-stats/)** - Helps display forum status such as total users, forums, topics, replies, tags, and all necessary details.
0. **[Booked Calendar](https://elementpack.pro/demo/element/booked-calendar/)** - Now enjoy integration support for the third-party plugin named Booked Calendar for WordPress. Watch demo the now.
0. **[BuddyPress Member](https://elementpack.pro/demo/element/buddypress-member/)** - With the BuddyPress integration, you can show a member of your forum inside your webpage.
...
0. **[BuddyPress Group](https://elementpack.pro/demo/element/buddypress-group/)** - Supports BuddyPress integration for the page builder. You can show the group of your forum using this plugin. Watch the demo.
...
0. **[Charitable Donations](https://elementpack.pro/demo/element/charitable-donations/)** - Charitable Donations displays donations history of all running campaigns highlighting donated amount along with time/date.
0. **[Charitable Donors](https://elementpack.pro/demo/element/charitable-donors/)** - The charitable donors widget displays donor information along with name, avatar, amount, and location. Motivate people by showing valuable donors' activity.
0. **[Charitable Donation Form](https://elementpack.pro/demo/element/charitable-donation-form/)** - The Charitable Donation Form allows valuable donors to donate within your website, leaving behind the tiring process of redirecting to external sites.
0. **[Charitable Login](https://elementpack.pro/demo/element/charitable-login/)** - The Charitable login widget lets your donors easily access your campaigns along with their profile. Also works greatly as a normal login interface.
0. **[Charitable Profile](https://elementpack.pro/demo/element/charitable-profile/)** - The Charitable profile widget allows donors to create their donor profile, providing necessary personal information. So, let's create a clean profile dedicated to our valued donors.
0. **[Charitable Registration](https://elementpack.pro/demo/element/charitable-registration/)** - The Charitable registration widget let your users and donors register to your campaigns with an easy-to-use and simple interface.
0. **[Charitable Stat](https://elementpack.pro/demo/element/charitable-stat/)** - The Charitable stat displays the current progress of your running campaign. Display numeric values, as well as progress bars.
...
0. **[Event Calendar Countdown](https://elementpack.pro/demo/element/event-calendar-countdown/)** - Event Calendar Countdown style can be customized with color, border, background color, padding margin, and position. 
0. **[Easy Digital Downloads](https://elementpack.pro/demo/element/easy-digital-downloads/)** - Easy digital downloads offers product display with price, modified style, border options. It gives your site another level of functionality.
0. **[EDD Cart](https://elementpack.pro/demo/element/edd-cart/)** - The EDD Cart can show the selected products that your customer has chosen for checkout. The widget provides smart customizations to highlight the cart button and interface for better user experience. 
0. **[EDD Category Grid](https://elementpack.pro/demo/element/edd-category-grid/)** - For displaying your online store products by their categories, you can use the EDD Product Grid. This is a trendy widget that provides a refreshing interface with lots of customizations for boosting the user experience
0. **[EDD Category Carousel](https://elementpack.pro/demo/element/edd-category-carousel/)** - The EDD Category Carousel works as a slider for displaying store products by their categories on your website. The widget is packed with customizing options to let you display product categories with trendy designs
0. **[EDD Checkout](https://elementpack.pro/demo/element/edd-checkout/)** - With EDD Checkout inserted within your online shop, you can provide a faster and easy-to-use product checkout system to your visitors along with lots of customizations to make the checkout process enjoyable
0. **[EDD Login](https://elementpack.pro/demo/element/edd-login/)** - The EDD Login provides a login interface within WordPress that you can include inside your webpage to let users log in to their personal user account on EDD and manage user profile, orders, or information.
...
0. **[EDD Product Carousel](https://elementpack.pro/demo/element/edd-product-carousel/)** - Using the EDD Product Carousel, you can design quality product sliders to showcase your eCommerce products with colorful appearance, style, and animations. It's easy to use and delivers a minimalistic view
0. **[EDD Product Reviews](https://elementpack.pro/demo/element/edd-product-reviews/)** - Helps you display customer reviews on individual and bulk products from EDD plugin and empowers you with so much controls over customizations.
0. **[EDD Product Review Carousel](https://elementpack.pro/demo/element/edd-product-review-carousel/)** - Create review sliders out of the EDD product reviews using this flexible carousel feature and captivate your potential customers with user trusts.
0. **[EDD Profile Editor](https://elementpack.pro/demo/element/edd-profile-editor/)** - With Easy Download Portfolio Editor: you can set text color, padding, margin, border type, border width, color, and size.
0. **[EDD Purchase History](https://elementpack.pro/demo/element/edd-purchase-history/)** - Easy Digital Downloads Purchase History offers modifications and other options like border color, background color matching modules.
...
0. **[Events Calendar Carousel](https://elementpack.pro/demo/element/events-calendar-carousel/)** - The Event Carousel widget allows you to create a carousel window, especially for upholding events.
0. **[Events Calendar List](https://elementpack.pro/demo/element/events-calendar-list/)** - With event List now you can showcase your event with more style and organized way. That can increase your CTR and make more conversion.
...
0. **[Give Donation History](https://elementpack.pro/demo/element/give-donation-history/)** - The Give Donation history widget displays all the donations that happened on your page, including every campaign. It is your simplified memo pad, reminding you about all donation activities.
0. **[Give Donor Wall](https://elementpack.pro/demo/element/give-donation-wall/)** - The Give Donor Wall is for creating a promotional charity showcase with your valued donors. Display all donors' identity and donation amount stacked in a wall formation to boost community morale.
0. **[Give Form Grid](https://elementpack.pro/demo/element/give-form-grid/)** - The Give Grid widget allows you to display multiple running campaigns in a grid formation. It helps to upload large events simultaneously.
0. **[Give Form](https://elementpack.pro/demo/element/give-form/)** - The Give Form widget is for creating easy to access donation form for charity events. 1-click to be a donor now!
0. **[Give Goal](https://elementpack.pro/demo/element/give-goal/)** - The Give goal widget is for displaying running charity campaigns alongside current progress via a progress bar.
0. **[Give Login](https://elementpack.pro/demo/element/give-login/)** - The Give login creates a login field where regular users can log in using their login information. 
0. **[Give Profile Editor](https://elementpack.pro/demo/element/give-profile-editor/)** - The Give Give Profile editor is for accessing and editing your donor profile while having a more simplified interface, including password change fields.
0. **[Give Receipt](https://elementpack.pro/demo/element/give-receipt/)** - The Give Receipt prints out a confirmation message on display against successful/failed donation.
0. **[Give Register](https://elementpack.pro/demo/element/give-register/)** - The Give register creates a registration form for users/donors who want to take part in your charity campaigns. 
...
0. **[Layer Slider](https://elementpack.pro/demo/element/layer-slider/)** - One of the best  WordPress slider in the market with lots of options and features. Its shortcode supports the page builder.
0. **[Mailchimp For WordPress](https://elementpack.pro/demo/element/mailchimp-for-wordpress/)** - Mailchimp can skyrocket your subscriber list if you use it on your site. Can integrate it with the page builder.
0. **[Portfolio Carousel](https://elementpack.pro/demo/element/portfolio-carousel)** - The Portfolio Carousel widget makes amazingly beautiful portfolios for products, services, and persons.
...
0. **[WP Forms](https://elementpack.pro/demo/element/wp-forms/)** - Drag & Drop WordPress Form Builder plugin supported by our WordPress plugin to make the design work much easier. 
...
0. **[WooCommerce Mini Cart](https://elementpack.pro/demo/element/woocommerce-mini-cart)** - Display a minified shopping cart on your WooCommerce website and let users easy access the information of their current purchases on the go.
...
0. **[WooCommerce Checkout Page](https://elementpack.pro/demo/element/woocommerce-checkout-page/)** - To match your brand design, Customize look and feel on your eCommerce website WooCommerce Checkout tools is a great way.
...
0. **[360° Product Viewer](https://elementpack.pro/demo/element/360-product-viewer/)** - 3D Product viewer for the page builder is the perfect tool that you need for your eCommerce site. Check this element pack addon demo
...
0. **[Parallax Background](https://elementpack.pro/demo/element/parallax-background/)** - Parallax Background is an awesome tool to design your sections and blocks to brush up more to fine-tune its looks.
...
0. **[Sound Effects](https://elementpack.pro/demo/element/sound-effects/)** - The sound effect extension adds JS sound playbacks to the existing site elements like texts, titles, images, buttons, etc. Make website a fun project by using this amazing feature. See the demo
...
Visit [BdThemes](https://bdthemes.com/) to learn about our services, page builder based products, informative blogs, and documentations.
...
= 5.4.2 [1st October 2023] =

* Added: Fancy list style 3 added
* Added: Icon Size option added in modal widget
* Fixed: SVG Image widget issue fixed (Thanks to Philipp Ekstrand)

= 5.4.1 [9th September 2023] =

* Added: Icon background size & font size option added in (brand skin) member widget

= 5.4.0 [3rd September 2023] =

* Added: Reading timer widget added
* Added: Stacker widget added (pro)
* Added: Item row gap & auto hiding menu shadow option added in navbar widget
* Added: Image advanced size & inline option added in review card, review card carousel widgets
* Updated: Admin Widget Analytics Notice improved
* Updated: Admin System memory lagging improved

= 5.3.1 [16th August 2023] =

* Added: Webhook Form widget added (pro)
* Added: Schema feature added in Accordion widget

= 5.3.0 [7th August 2023] =

* Added: Fancy icons widget unlock from pro
* Fixed: Fix keyboard navigation in Navbar component
* Fixed: Fix aria-roledescription attribute in Slider nav component
* Fixed: Fix delayed show in Drop component shows drop, although toggle is no longer hovered
* Fixed: Fix potential rounding issues in offset() function, when used as setter
* Fixed: Fix to ensure Slider items have max-width: 100%

= 5.2.3 [30th July 2023] =

* Updated: Cache Time feature updated in Facebook Feed widget
* Fixed: PHP warning issue fixed in Slider (Thanks to Dimon)

= 5.2.2 [24th July 2023] =

* Updated: System Improved

= 5.2.1 [22th July 2023] =
...
* Added: Item wrapper link option added in product carousel widget
* Added: Link to button, title, image, item option added in static carousel widget
* Added: One column added in Logo Grid widget (Thanks to David Gilfillan)

= 5.1.3 [21st June 2023] =

* Fixed: Elementor pro (swiper) Compatibility issue fixed

= 5.1.2 [18th June 2023] =

* Updated: System Improved

= 5.1.1 [12th June 2023] =

* Updated: Readme file improved
...
* Added: Style sliding box added in image accordion widget
* Added: Vertical align & active item expand option added in image accordion widget
* Added: Lightbox & item gap option added in image accordion widget
...
* Added: Dropbar widget unlock from pro
* Added: Product Grid widget unlock from pro
* Added: Individual Style label margin option added in Countdown widget
* Fixed: Elementor v3.10.0 deprication issue fixed
...
- Of course, you can. In fact, we bring new & unique widgets over the frequent updates (minor updates). With every leap of the base plugin version (major updates), we bring tones of new widgets and features to let you take advantage of our plugin.
