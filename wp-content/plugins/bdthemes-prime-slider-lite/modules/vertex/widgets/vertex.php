...
class Vertex extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control( 'border_style_color', [
        ...
        $this->add_responsive_control( 'border_width_type', [
            'label'     => esc_html__( 'Border Line Width', 'bdthemes-prime-slider' ) . BDTPS_PC,
            'type'      => Controls_Manager::SLIDER,
            'range'     => [
            'px' => [
            'min' => 0,
    ...
    protected function render_header()
    {
        ...
        ?>>
        <div <?php 
        $this->print_render_attribute_string( 'prime-slider-vertex' );
        ?>>
        <div <?php 
