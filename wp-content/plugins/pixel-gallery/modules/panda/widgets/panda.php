...
namespace PixelGallery\Modules\Panda\Widgets;
...
class Panda extends Module_Base
{
	...
	{
		return BDTPG . esc_html__('Panda', 'pixel-gallery');
	}

	public function get_icon()
	{
		return 'pg-icon-panda';
	}
	...
	protected function register_controls()
	{
		...
		//Global
		$this->register_grid_controls('panda');
		$this->register_global_height_controls('panda');
		$this->register_title_tag_controls();
		$this->register_show_meta_controls();
		$this->register_show_date_controls();
		$this->register_alignment_controls('panda');
		...
		$this->register_repeater_grid_controls($repeater, 'panda');
		$this->register_repeater_item_height_controls($repeater, 'panda');
		$repeater->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-panda-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-panda-item:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .pg-panda-content' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->register_title_controls('panda');

		//Global meta Controls
		$this->register_meta_controls('panda');
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pg-panda-date' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-date' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-date' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-panda-date' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
...
?>
		<?php if (!empty($item['date_month']) or !empty($item['date_day'])) : ?>
			<div class="pg-panda-date">
				<span class="pg-panda-month"><?php echo wp_kses_post($item['date_month']); ?></span>
				<span class="pg-panda-day"><?php echo wp_kses_post($item['date_day']); ?></span>
			</div>
		<?php endif;
	}
	...
	{
		$settings = $this->get_settings_for_display();
		$id = 'pg-panda-' . $this->get_id();
		$slide_index = 1;
		foreach ($settings['items'] as $index => $item) :

			$attr_name = 'grid-item' . $index;
			$this->add_render_attribute($attr_name, 'class', 'pg-panda-item pg-item elementor-repeater-item-' . esc_attr($item['_id']), true);
		...
		<div <?php $this->print_render_attribute_string($attr_name); ?>>
			...
			<?php $this->render_image_wrap($item, 'panda'); ?>
					<div class="pg-panda-content">
						<?php $this->render_meta($item, 'panda'); ?>
						<?php $this->render_title($item, 'panda'); ?>
					</div>
	...
	{
		$settings   = $this->get_settings_for_display();
		$this->add_render_attribute('grid', 'class', 'pg-panda-grid pg-grid');
