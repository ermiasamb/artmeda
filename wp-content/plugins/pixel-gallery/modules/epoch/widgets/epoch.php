...
namespace PixelGallery\Modules\Epoch\Widgets;
...
class Epoch extends Module_Base {
	...
	public function get_title() {
		return BDTPG . esc_html__('Epoch', 'pixel-gallery');
	}

	public function get_icon() {
		return 'pg-icon-epoch';
	}
	...
	public function get_custom_help_url() {
		return 'https://youtu.be/BPIfzG7RMw8';
	}
	...
	protected function register_controls() {
		...
		//Global
		$this->register_grid_controls('epoch');
		$this->register_global_height_controls('epoch');
		$this->register_title_tag_controls();
		$this->register_show_meta_controls();
		$this->register_content_alignment_controls('epoch');
		...
		$this->register_repeater_grid_controls($repeater, 'epoch');
		$this->register_repeater_item_height_controls($repeater, 'epoch');
		$repeater->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-epoch-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-epoch-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-epoch-item:hover',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .pg-epoch-image-wrap:before' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				'name'      => 'image_border',
				'selector'  => '{{WRAPPER}} .pg-epoch-image-wrap',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-image-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-image-wrap' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->register_title_controls('epoch');

		//Global Meta Controls
		$this->register_meta_controls('epoch');
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pg-epoch-link-button a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-epoch-link-button a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-link-button a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-link-button a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-epoch-link-button a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pg-epoch-link-button a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-epoch-link-button a:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		//Clip Path Controls
		$this->register_clip_path_controls('epoch');
	}

	public function render_link_button($item, $index, $id) {
		...
		<?php if ($link) : ?>
			<div class="pg-epoch-link-button">
				<a class="pg-epoch-zoom-btn" <?php $this->print_render_attribute_string('link' . $index); ?>><?php echo wp_kses_post($item['link_button_zoom']); ?></a>
				<a class="pg-epoch-view-btn" <?php $this->print_render_attribute_string('link' . $index); ?>><?php echo wp_kses_post($item['link_button_view']); ?></a>
			</div>
		<?php endif; ?>
		<?php
	}
	...
	public function render_items() {
		...
		<div <?php $this->print_render_attribute_string($attr_name); ?>>
			...
			<div class="pg-epoch-content">
				...
				<?php $this->render_meta($item, 'epoch'); ?>
				<?php if ('none' !== $settings['link_to'] && $settings['link_target'] == 'only_button') : ?>
					<?php $this->render_link_button($item, $index, $id); ?>
				<?php endif; ?>
			</div>
	...
	public function render() {
		$settings   = $this->get_settings_for_display();
		$this->add_render_attribute('grid', 'class', 'pg-epoch-grid pg-grid');
