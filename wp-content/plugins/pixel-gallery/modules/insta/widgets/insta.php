...
namespace PixelGallery\Modules\Insta\Widgets;
...
class Insta extends Module_Base {
	...
	public function get_title() {
		return BDTPG . esc_html__('Insta', 'pixel-gallery');
	}

	public function get_icon() {
		return 'pg-icon-insta';
	}
	...
	protected function register_controls() {
		...
		$this->register_alignment_controls('insta');
		...
		$this->register_repeater_grid_controls($repeater, 'insta');
		$this->register_repeater_item_height_controls($repeater, 'insta');
		$repeater->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .pg-insta-item',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-item, {{WRAPPER}} .pg-insta-image-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-insta-item:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-insta-item:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .pg-insta-content' => 'backdrop-filter: blur({{SIZE}}px); -webkit-backdrop-filter: blur({{SIZE}}px);'
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .pg-insta-content',
				'separator' => 'before',
				// 'fields_options' => [
				// 	'background' => [
				// 		'default' => 'classic',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->register_title_controls('insta');
        
		//Global Meta Controls
		$this->register_meta_controls('insta');
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pg-insta-social-icon span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .pg-insta-social-icon span',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-social-icon span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-social-icon span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-insta-social-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-insta-social-icon span' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-insta-social-icon' => 'grid-row-gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pg-insta-social-icon a:hover span' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .pg-insta-social-icon span::before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-insta-social-icon a:hover span' => 'border-color: {{VALUE}};',
				],
			]
		);
	...
	public function render_social_link($item) {
		...
		$this->add_render_attribute('social-icon', 'class', 'pg-insta-social-icon');
	...
	public function render_items() {
        $settings = $this->get_settings_for_display();
		$id = 'pg-insta-' . $this->get_id();
		$slide_index = 1;
		foreach ($settings['items'] as $index => $item) :

			$attr_name = 'grid-item' . $index;
			$this->add_render_attribute($attr_name, 'class', 'pg-insta-item pg-item elementor-repeater-item-' . esc_attr($item['_id']), true);
		...
		<div <?php $this->print_render_attribute_string($attr_name); ?>>
			...
			<?php $this->render_image_wrap($item, 'insta'); ?>
			<div class="pg-insta-content">
				<div class="pg-insta-inner-content">
					<?php $this->render_title($item, 'insta'); ?>
					<?php $this->render_meta($item, 'insta'); ?>
