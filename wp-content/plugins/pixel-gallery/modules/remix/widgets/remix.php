...
namespace PixelGallery\Modules\Remix\Widgets;
...
class Remix extends Module_Base
{
	...
	{
		return BDTPG . esc_html__('Remix', 'pixel-gallery');
	}

	public function get_icon()
	{
		return 'pg-icon-remix';
	}
	...
	protected function register_controls()
	{
		...
		//Global
		$this->register_grid_controls('remix');
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-remix-item-box' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'masonry' => ''
				]
		...
		$this->register_repeater_grid_controls($repeater, 'remix');
		$repeater->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pg-remix-grid {{CURRENT_ITEM}} .pg-remix-item-box' => 'height: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pg-remix-content-wrap',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-content-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'      => 'image_border',
				'selector'  => '{{WRAPPER}} .pg-remix-item-box img',
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-item-box img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-item-box img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em', '%'],
				'selectors'  => [
					'{{WRAPPER}} .pg-remix-item-box:hover img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->register_title_controls('remix');

		//Global meta Controls
		$this->register_meta_controls('remix');
	...
	public function render_items()
	{
		...
		$id = 'pg-remix-' . $this->get_id();
		$slide_index = 1;
		foreach ($settings['items'] as $index => $item) :

			$attr_name = 'grid-item' . $index;
			$this->add_render_attribute($attr_name, 'class', 'pg-remix-item pg-item elementor-repeater-item-' . esc_attr($item['_id']), true);
		...
		<div <?php $this->print_render_attribute_string($attr_name); ?>>
			...
			<div class="pg-remix-item-box">
						<?php $this->render_image_wrap($item, 'remix'); ?>
						<div class="pg-remix-content-wrap">
							<div class="pg-remix-content">
								<?php $this->render_title($item, 'remix'); ?>
								<?php $this->render_meta($item, 'remix'); ?>
							</div>
							<?php if ('none' !== $settings['link_to'] && $settings['link_target'] == 'only_button') : ?>
								<?php $this->render_readmore($item, $index, $id, 'remix'); ?>
							<?php endif; ?>
						</div>
					</div>
