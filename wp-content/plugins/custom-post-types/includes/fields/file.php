            ...
            <div class="cpt-file-section"
                ...
                <div class="cpt-file-wrap">
                    <div class="cpt-file-preview">
                        <?php
                        echo $config['value'] && wp_get_attachment_image($config['value'], 'thumbnail', false, []) ? wp_get_attachment_image($config['value'], 'thumbnail', false, []) : '<img src="" width="150" height="150" style="display: none;" class="attachment-thumbnail size-thumbnail" alt="" loading="lazy">';
                        ?>
                    </div>
