...
use CustomPostTypes\includes\classes\FieldGroups;

$fieldsClass = new FieldGroups();

add_filter(Utils::getHookName('field_types'), function ($fields) use ($fieldsClass) {
...
add_filter(Utils::getHookName('register_ajax_actions'), function ($actions) use ($fieldsClass) {
    $actions['cpt-get-repeater-group'] = [
        ...
        'callback' => function ($params) use ($fieldsClass) {
            ...
            return $renderCallback['repeater']['groupTemplateCallback']($fields, $parent);
        },
    ];
