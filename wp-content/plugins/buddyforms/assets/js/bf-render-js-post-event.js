		jQuery(document.body).on('submit', '#buddyforms_form_post-event', function (event) {
		    var formIsInitialized = jQuery(this).data('initialize');
		    var formSlug = 'post-event';
            ...
            if(BuddyFormsHooks){
                ...
                BuddyFormsHooks.doAction('buddyforms:form:render', ["post-event", ["bootstrap","jQuery","focus"], "buddyforms_ajax_process_edit_post", "post", formTargetStatus]);
            } else {
