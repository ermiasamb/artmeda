		jQuery(document.body).on('submit', '#buddyforms_form_user-post', function (event) {
		    var formIsInitialized = jQuery(this).data('initialize');
		    var formSlug = 'user-post';
            ...
            if(BuddyFormsHooks){
                ...
                BuddyFormsHooks.doAction('buddyforms:form:render', ["user-post", ["bootstrap","jQuery","focus"], "buddyforms_ajax_process_edit_post", "post", formTargetStatus]);
            } else {
