                    ...
                    <td>
                        <div class="bp-better-messages-roles-list">
                            ...
                            <?php if( count( $roleBlock ) === 0 ){ ?>
                                <div class="role-block-empty"><?php echo esc_attr_x('No role block rules added',  'Settings page', 'bp-better-messages'); ?></div>
                            <?php } ?>
                            ...
                            <table style="margin:0 -8px;">
                                ...
                                <tr>
                                    ...
                                    <th><?php _ex( 'Message', 'Settings page', 'bp-better-messages' ); ?></th>
                                    <th></th>
                                </tr>
                                </thead>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td>
                            ...
                            <table class="widefat bm-switcher-table">
                                ...
                                <tr>
                                    <td>
                                        <input name="enableGroupsPushs" type="checkbox" <?php if ( ! bp_is_active( 'groups' ) ) echo 'disabled'; ?> <?php checked( $this->settings[ 'enableGroupsPushs' ], '1' ); ?> value="1" />
                                    </td>
                                    <th>
                                        <?php _ex( 'Push Notifications', 'Settings page', 'bp-better-messages' ); ?>
                                        <p style="font-size: 10px;"><?php _ex( 'When enabled users will receive push notifications for Group Chats', 'Settings page', 'bp-better-messages' ); ?></p>
