 ...
 */
/** Range Control */
class Film_Maker_Lite_Range_Slider extends WP_Customize_Control {
    /**
    ...
    public function enqueue() {
        wp_enqueue_style( 'film_maker_lite-range-control-styles', get_parent_theme_file_uri( '/assets/css/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'film_maker_lite-range-control-scripts', get_parent_theme_file_uri( '/assets/js/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
    ...
    public function render_content() {
        ...
        <div class="control-wrap"> 
            ...
            <div class="ms-slider-reset dashicons dashicons-image-rotate" slider-reset-value="12"></div>
